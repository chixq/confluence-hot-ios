...
<p align="center">
  <img src="IconPreviews/AppIconHot-B.png" alt="Confluence Hot App Icon" width="128">
</p>

Confluence Hot iOS 是一个面向 Confluence Server / Data Center 自建站点的原生 SwiftUI 客户端，也是一款 Confluence 官方 App 的开源平替。它的出发点很直接：官方 Confluence Data Center iOS App 已经很久没有明显更新，一些新的 iOS 技术、交互体验和潜在安全修复没有及时跟进，同时官方 App 也缺少“热门内容”这类很适合团队知识库的信息入口。
...
- “工作”页顶部提供 bento 快捷入口：草稿箱展示 Confluence 草稿和本地未发布编辑，待办为本地任务列表，不依赖 Confluence 页面。
- 支持空间列表，进入空间后继续分页浏览该空间下的页面和博客。
- 支持统一搜索，搜索结果高亮命中的标题和摘要关键词；搜索页内置本周热门、回复、新建等预设，并支持添加自定义 CQL 预设。
